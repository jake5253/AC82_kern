...
#define ENCODER_UCV_BASE                                    (IO_UCV_BASE + 0x02000)
...
#define IOMMU_UCV_BASE                                      (IO_UCV_BASE + 0x09000)
#define MSDC2_UCV_BASE                                      (IO_UCV_BASE + 0x0A000)
#define MSDC0_UCV_BASE                                      (IO_UCV_BASE + 0x0B000)
...
#define USB_SIF_UCV_BASE                                    (IO_UCV_BASE + 0x0F000)
//#define TCMGPR_UCV_BASE                                   (IO_UCV_BASE + 0x10000)
#define FLASHIF_UCV_BASE                                    (IO_UCV_BASE + 0x11000)
...
#define PVR_UCV_BASE                                        (IO_UCV_BASE + 0x19000) //DDI
...
#define VDOUT_TVD_TOP_UCV_BASE                              (IO_UCV_BASE + 0x1F000)
#define VDOUT_AUX_UCV_BASE                                  (IO_UCV_BASE + 0x43000) //AC83XX_PMX
#define OSD_TOP_UCV_BASE                                    (IO_UCV_BASE + 0x20000)
#define MSDC1_UCV_BASE                                      (IO_UCV_BASE + 0x21000)
#define HDMI_UCV_BASE                                       (IO_UCV_BASE + 0x22000)
#define SPI_UCV_BASE                                        (IO_UCV_BASE + 0x23000)
...
#define SIFM_UCV_BASE                                       (IO_UCV_BASE + 0x30000)
#define SIFS_UCV_BASE                                       (IO_UCV_BASE + 0x31000)
#define AU_PWM_UCV_BASE                                     (IO_UCV_BASE + 0x32000)
...
#define AUDIO_FTI_UCV_BASE                                  (IO_UCV_BASE + 0x3B000)
...
#define IRT_DMA_UCV_BASE                                    (IO_UCV_BASE + 0x46000)
#define ADSP3_UCV_BASE                                      (IO_UCV_BASE + 0x47000)  //remove from ac8317
#define SPM_UCV_BASE                                        (IO_UCV_BASE + 0x48000)
...
#define AU_PERI_LARB_UCV_BASE                               (IO_UCV_BASE + 0x53000)
//#define Resv_UCV_BASE                                     (IO_UCV_BASE + 0x54000)
#define CORESIGHT_UCV_BASE                                  (IO_UCV_BASE + 0x55000)
...
#define DDRPHY_UCV_BASE                                     (IO_UCV_BASE + 0x5A000)
//#define POST_PROC_UCV_BASE                                (IO_UCV_BASE + 0x5B000)
#define MFG_UCV_BASE                                        (IO_UCV_BASE + 0x60000)
#define OSD_R_UCV_BASE                                      (IO_UCV_BASE + 0xA3000)
#define FPD_UCV_BASE                                        (IO_UCV_BASE + 0xA4000)
#define LVDS_UCV_BASE                                       (IO_UCV_BASE + 0xA5000)
#define LVDS_ANA_UCV_BASE                                   (IO_UCV_BASE + 0xA6000)
#define TVD_UCV_BASE                                        (IO_UCV_BASE + 0xA7000)
#define AUDIO_RGBK2_UCV_BASE                                (IO_UCV_BASE + 0xA8000)
#define TP_UCV_BASE                                         (IO_UCV_BASE + 0xA9000)
