/*
 *  linux/arch/arm/mach-ac83xx/pll.c
 *
...
#define AC83XX_BUS_CLOCK  216000000
...
#endif // end of #if (CONFIG_CHIPI_VER_CURR == CONFIG_CHIP_VER_AC83XX)
...
// public functions
//==================================================
void v_ac83xx_calibrate_plls(void)
{
    // APLL
    printk("APLL Setting\n");
    _CalAPLL(0);
